    ...
    <form action="../controllers/Transacciones.php" method="post" style="width: 400px; margin: auto;">
        ...
        <div class="form-group">
            ...
            <select name="estilo" required id="estilo" class="form-control">
                <?php while ($estilo = $resultado->fetch(PDO::FETCH_ASSOC)) { ?>
        ...
        <div class="form-group">
            ...
            <input type="text" name="portada" required id="portada" class="form-control"
                   placeholder="Portada del artista">
        </div>
        <div class="form-group">
            <button type="submit" name="nuevo_artista"
                    class="btn btn-primary btn-lg btn-block">Agregar artista</button>
        </div>
    </form>
